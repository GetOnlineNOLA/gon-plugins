...
<section class="related products">
    ...
    <div class="col-sm-<?php if($cols == 1){echo'12';}elseif($cols == 2){echo'6';}elseif($cols == 3){echo'4';}elseif($cols == 4){echo'3';}?> related-product-wrapper"><a class="related-product" href="<?php echo get_the_permalink(get_the_ID());?>"><img src="<?php  echo $image[0]; ?>" data-id="<?php echo get_the_ID(); ?>" class="related-product-image">
